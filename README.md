...
## 1. `MGCD_recden`
In this file, computations are performed over $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)$ using the `recden` library. The following subalgorithms are included:
### `LAminpoly`
Computes the generator polynomial M(z) s.t
$\bar{L}_p = \mathbb{Z}_p[z]/\langle m(z) \rangle \cong L_p = \mathbb{Z}_p[z_1, \ldots, z_n]/\langle M_1, \ldots, M_n \rangle$.
...
of a polynomial.
### `MGCD1`
Computes the monic GCD of two polynomials in $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)[x_1, \ldots, x_k]$ using `LAminpoly`.
### `MGCD2`
Computes the monic GCD of two polynomials in $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)[x_1, \ldots, x_k]$ without using `LAminpoly`.
### `PGCD`
...
****************************************************************************************************************
## 2. `MRS`
In this file, computations are performed over $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)$ using the Maple library  RDP := Algebraic:-RecursiveDensePolynomials
...
### `MRES1`
Computes the resultant of two polynomials in $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)[x_1, \ldots, x_k]$
using `LAminpoly`.
### `MRES2`
Computes the resultant of two polynomials in $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)[x_1, \ldots, x_k]$ without using `LAminpoly`.
### `PRES`
...
****************************************************************************************************************
## 3. `MGCD_RDP`
In this file, computations are performed over $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)$ using the Maple library
RDP := Algebraic:-RecursiveDensePolynomials
****************************************************************************************************************
## Note on Benchmark Comparisons
The RDP library already includes optimized routines for computing GCDs over $\mathbb{Q}(\alpha_1, \ldots, \alpha_n)$.
